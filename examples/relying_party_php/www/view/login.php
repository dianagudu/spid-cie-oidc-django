...
<head>
    ...
    <link rel="stylesheet"
        href="<?php echo $BASEURL; ?>/assets/spid-sp-access-button/css/spid-sp-access-button.min.css" />
...
<body>
                    ...
                    <div id="login-form" class="login-form-lg shadow mx-auto mt-3">
                        ...
                        <ul class="nav nav-tabs flex-sm-row flex-sm-nowrap" id="myTab" role="tablist">
                            <li class="nav-item text-sm-center" role="presentation">
                                <button class="nav-link h-100 px-4 active" id="tab-spid" data-bs-toggle="tab"
                                    data-bs-target="#panel-spid" type="button" role="tab" aria-controls="home"
                                    aria-selected="true">SPID</button>
                            </li>
                            <li class="nav-item text-sm-center" role="presentation">
                                <button class="nav-link h-100 px-4" id="tab-cie" data-bs-toggle="tab"
                                    data-bs-target="#panel-cie" type="button" role="tab" aria-controls="profile"
                                    aria-selected="false">CIE</button>
                            </li>
                            <li class="nav-item text-sm-center" role="presentation">
                                <button class="nav-link h-100 px-4" id="tab-op" data-bs-toggle="tab"
                                    data-bs-target="#panel-op" type="button" role="tab" aria-controls="profile"
                                    aria-selected="false">OP</button>
                            </li>
                        </ul>
                        <div class="tab-content" id="tab-content">
                            <div class="tab-pane fade show active" id="panel-spid" role="tabpanel"
                                aria-labelledby="tab-spid">
                                <h3 class="sr-only">Accedi con identità digitale SPID</h3>
                                <p>SPID, il&nbsp;<strong>Sistema Pubblico di Identità Digitale</strong>&nbsp;è il
                                    sistema di accesso che consente di utilizzare, con un'identità digitale unica, i
                                    servizi online della Pubblica Amministrazione e dei privati accreditati. Se sei già
                                    in possesso di un'identità digitale, accedi con le credenziali del tuo gestore. Se
                                    non hai ancora un'identità digitale, richiedila ad uno dei gestori.</p>
                                ...
                                <div class="row align-items-center">
                                        ...
                                        <ul class="list-link px-1">
                                            <li class="mb-1">
                                                <a href="https://www.spid.gov.it/" target="_blank"
                                                    ...
                                                    <span class="sr-only">Apre una nuova finestra</span>Maggiori
                                                    informazioni su SPID</a>
                                            </li>
                                            <li class="mb-1">
                                                <a href="https://www.spid.gov.it/richiedi-spid" target="_blank"
                                                    rel="noopener noreferrer">
                                                    <span class="sr-only">Apre una nuova finestra</span>Non hai
                                                    SPID?</a>
                                            </li>
                                            <li class="mb-1">
                                                <a href="https://www.spid.gov.it/serve-aiuto" target="_blank"
                                                    rel="noopener noreferrer">
                                    ...
                                    <div class="col-12 col-md-6 text-center">
                                        ...
                                        <a href="#" class="italia-it-button italia-it-button-size-m button-spid"
                                            spid-idp-button="#spid-idp-button-medium-get" aria-haspopup="true"
                                            aria-expanded="false">
                                            <span class="italia-it-button-icon"><img
                                                    src="<?php echo $BASEURL; ?>/assets/spid-sp-access-button/img/spid-ico-circle-bb.svg"
                                                    onerror="this.src='<?php echo $BASEURL; ?>/assets/spid-sp-access-button/img/spid-ico-circle-bb.png'; this.onerror=null;"
                                                    alt="" /></span>
                                        ...
                                        <div id="spid-idp-button-medium-get"
                                            ...
                                            <ul id="spid-idp-list-medium-root-get" class="spid-idp-button-menu"
                                                ...
                                                <li class="spid-idp-button-link" data-idp="test">
                                                    <a
                                                        href="<?php echo $BASEURL; ?>/oidc/rp/<?php echo $DOMAIN; ?>/authz/<?php echo base64_encode('http://trust-anchor.org:8000/'); ?>/<?php echo base64_encode('http://trust-anchor.org:8000/oidc/op/'); ?>?state=TEST"><span
                                                            class="spid-sr-only">TEST</span><img
                                                            src="<?php echo $BASEURL; ?>/assets/img/spid_test_provider.png"
                                                            onerror="this.src='<?php echo $BASEURL; ?>/assets/img/spid_test_provider.png'; this.onerror=null;"
                                                            alt="Provider TEST" /></a>
                                                </li>
                                                <!--
                                    ...
                                    <img id="spid-agid" class="img-fluid mx-auto"
                                        src="<?php echo $BASEURL; ?>/assets/img/spid-agid-logo-lb.png"
                                        alt="Logo SPID - AGID - Agenzia per l'Italia Digitale">
                                </div>
                            </div>
                            <div class="tab-pane fade" id="panel-cie" role="tabpanel" aria-labelledby="tab-cie">
                                ...
                                <p>La <strong>Carta di Identità Elettronica</strong> (CIE) è il documento personale che
                                    attesta l'identità del cittadino.
                                    Dotata di microprocessore, oltre a comprovare l'identità personale, permette
                                    l'accesso ai servizi digitali della Pubblica Amministrazione.</p>

                                <div class="row align-items-center">
                                    <div class="col-12 col-md-6">
                                        <a class="my-3" href="https://www.cartaidentita.interno.gov.it/" target="_blank"
                                            rel="noopener noreferrer">
                                    ...
                                    <div class="col-12 col-md-6 text-center">
                                        <li class="btn p-0 border-0 my-3">
                                            <a
                                                href="<?php echo $BASEURL; ?>/oidc/rp/<?php echo $DOMAIN; ?>/authz/<?php echo base64_encode('http://trust-anchor.org:8000/'); ?>/<?php echo base64_encode('http://cie-provider.org:8002/oidc/op/'); ?>?state=state123">
                                                <img class="img-fluid"
                                                    src="<?php echo $BASEURL; ?>/assets/img/cie_button.png"
                                                    alt="Entra con CIE">
                                ...
                                <img class="img-fluid mx-auto" src="<?php echo $BASEURL; ?>/assets/img/MI_logo.png"
                                    alt="Logo del Ministero dell’Interno">
                            </div>
                            <div class="tab-pane fade" id="panel-op" role="tabpanel" aria-labelledby="tab-op">
                                <h3 class="sr-only">Log in with OP from another federation</h3>
                                <p>Log in with op.fedservice.lh</p>
                                <div class="row align-items-center">
                                    <div class="col-12 col-md-6">
                                    ...
                                    <div class="col-12 col-md-6 text-center">
                                        <li class="btn p-0 border-0 my-3">
                                            <a
                                                href="<?php echo $BASEURL; ?>/oidc/rp/<?php echo $DOMAIN; ?>/authz/<?php echo base64_encode('https://trust-anchor.org:8000/'); ?>/<?php echo base64_encode('https://op.fedservice.lh'); ?>?state=state123">
                                                <img class="img-fluid"
                                                    src="<?php echo $BASEURL; ?>/assets/img/op_button.png"
                                                    alt="Login with OP">
                                                <span class="sr-only">Log in with OP from another federation</span>
                                            </a>
                                        </li>
                                    </div>
                                </div>
    ...
    <script type="text/javascript" src="<?php echo $BASEURL; ?>/assets/spid-sp-access-button/js/jquery.min.js"></script>
    <script type="text/javascript"
        src="<?php echo $BASEURL; ?>/assets/spid-sp-access-button/js/spid-sp-access-button.min.js"></script>
    <script>
